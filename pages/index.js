    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.mainContainer}>
                <div className={styles.InfoContainer}>
                    ...
                    <div className={styles.flexContainer}>
                        ...
                        <Link href='/login'><button className={styles.signButton}><strong>Sign In!</strong></button></Link>
                    </div>
                    <p className={styles.cardFooter}>Made with love by VolunteerUP Dev Team ❤️</p>

                    <div className={styles.svgContainer}>
                        <Image className={styles.svg} src="https://cdn.discordapp.com/attachments/865389806376321075/868326536883875890/undraw_elements_cipa.png" width="250" height="200" />
                    </div>
                </div>
            </div>
            ...
            <div className={styles.mainNonProfitCard}>
                <Image className={styles.CrossIcon} src="http://redcrossyouth.org/wp-content/uploads/2019/02/cropped-ARC_Logo_Bttn_Vert_RGB-e1549942783702.png" width="200" height="200" />
                <div>
            ...
            <div className={styles.mainNonProfitCard}>
                <Image className={styles.CrossIcon} src="https://upload.wikimedia.org/wikipedia/commons/5/5d/Black_Lives_Matter_logo.svg" width="200" height="200" />
                <div>
            ...
            <div className={styles.centerText} >
                <Link href="/featured-form"><p>Wanna be featured? Fill out this form</p></Link>
            </div>
        </div>
    )
}
